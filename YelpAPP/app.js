...
// cookie confiig , expiration date , etc
const sessionConfig = {
    store,
    name: 'session',
    secret,
    ...
    cookie:{
        httpOnly: true ,
        //secure:true, // only on https you can login
        expires: Date.now() + 1000 * 60 * 60 * 24 * 7,
        maxAge : 1000 * 60 * 60 * 24 * 7
    }
}

// !!!!!!! session-Config and session has to be before passport.session() / just saying
...
//                 "blob:",
//                 "data:",
//                 "https://res.cloudinary.com/dggghnwn9/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
